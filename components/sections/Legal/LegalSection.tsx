      ...
      <Container size="xl">
        ...
        <div className="mt-14 grid gap-5 md:mt-20 md:grid-cols-3 lg:gap-6">
          ...
          <LegalCard
            ...
            body="Марафет — налоговый агент по ст. 226 НК РФ. Перечисляем НДФЛ в ФНС за вас при каждой выплате. По доходам от Марафета декларацию 3-НДФЛ подавать не нужно."
            highlight="Чистыми на карту"
          />
          <LegalCard
            icon={<HeartPulse className="h-6 w-6" />}
            title="Страховые взносы за наш счёт"
            body="С каждого начисления платим в фонды полный пакет взносов: ОПС, ОМС, ВНиМ (около 30% сверх вашего вознаграждения). У вас идёт страховой стаж и накапливаются пенсионные баллы."
            highlight="Страховой стаж для пенсии"
          />
        </div>
        ...
        >
          ...
          <div className="mt-10 grid items-center gap-4 lg:grid-cols-[1fr_auto_1fr_auto_1fr]">
            ...
            <FlowBox
              ...
              sub="2% (1% L1 + 1% L2)"
              tone="purple"
              note="Страховые взносы (~30%, около 60 ₽) платим в фонды сверх — за наш счёт. С начисленных 200 ₽ удержим НДФЛ 13% = 26 ₽."
            />
            ...
            <FlowBox
              ...
              tone="success"
              note="+ страховой стаж и взносы на медицинское страхование"
            />
          </div>

          <div className="mt-10 grid gap-3 rounded-2xl bg-white/[0.04] p-5 ring-1 ring-inset ring-white/10 md:grid-cols-2">
            <FactRow text="По доходам от Марафета декларацию 3-НДФЛ подавать не нужно" />
            <FactRow text="Можно совмещать с основной работой по найму, самозанятостью или ИП" />
            <FactRow text="Лимита 2,4 млн ₽ (как у самозанятых) не применяется" />
            <FactRow text="Заявка на вывод в любой момент, выплата раз в месяц" />
          </div>
        </motion.div>
      </Container>
    </Section>
